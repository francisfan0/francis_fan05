...
//   ); // Assuming max 15 images per track
...
//   useEffect(() => {
//     setLoadingPercentage(new Array(imageTracks[currentTrack].length).fill(0));
//     setLoadingComplete(new Array(imageTracks[currentTrack].length).fill(false));
//   }, [currentTrack]);
...
//     setLoadingComplete((prev) => {
//       const updated = [...prev];
//       updated[index] = true; // Mark as complete even if there is an error
//       return updated;
//     });
//   };
...
//         </button>
//       </div>
//       <div className="track-controls" ref={trackRef}>
//         {imageTracks[currentTrack].map((imageId, index) => (
//           <div
//             key={index}
...
//           >
//             <img
//               src={cld.image(imageId).toURL()}
//               className="image"
//               alt={currentTrack}
//               onLoad={() => handleImageLoad(index)}
//               onError={() => handleImageError(index)}
//               style={{ opacity: loadingComplete[index] ? 1 : 0 }}
//             />
//             {!loadingComplete[index] && (
//               <div className="loading-overlay">
//                 <div className="loading-text">
//                   Loading {loadingPercentage[index]}%
//                 </div>
//               </div>
//             )}
//           </div>
